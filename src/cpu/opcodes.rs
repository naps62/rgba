...
pub fn decode(byte: u8) -> Opcode {
  match byte {
    ...
    _ if op_match(byte, 0b1110_1111, 0b0000_0010) => LD(PtrReg16(reg16(byte, 0, 2)), Reg8(A)),
    _ if op_match(byte, 0b1110_1111, 0b0000_1010) => LD(Reg8(A), PtrReg16(reg16(byte, 0, 2))),
